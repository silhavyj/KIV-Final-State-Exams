...
- zasobnikovy automat pro syntaktickou analyzu shora dolu
  ...
  - akceptate - prazdny vsup i zasobnik (= jen jeden pracovni stav)

  <img src="img/23/02.png">

- konstrukce deterministickeho automati, vhodny tvar gramatiky
...
- pro LL analyzator potrebujeme
  ...
  - pro jakoukoliv zpracovatelnou gramatiku staci obecny engine do ktereho se dosadi tabulka a doplni se gramatika
  ...
  - tomu mohou zabranit dve situace
    - first-first kolize
      ...
      - lze resit lookaheadem
        - => coz vyrazne zvetsi rozhladovou tabulku (musime pouzit vsechny kombinace vstupnich symbolu (sloupe) => exponencialni)
      ...
      - postup transformace gramatiky kvuli first-first kolizim
        ...
        - pote provedeme levou faktorizaci
          ...
          - => to muze zpusobit dalsi kolize, level rekurze, e pravidla, atd.
  ...
  - LL(k) gramatiky
    ...
    - prakticke vyuziti maji hlavne LL(1) analyzatoru a gramatiky protoze maji rozmne velke rozkladove tabulky
      - pro kazdou BKG existuje ekvivalentni gramatika GNF => takze LL(>1) nejsou vlastne vubec potreba
...
- vyjadrovaci sila LL a LR gramatik
  ...
  - TL;DR
    - leva rekurze je prekazdkou - pokud v gramatice jem neni mozne ji analyzovat
