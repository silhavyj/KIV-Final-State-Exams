...
- kurzory
  ...
  - typy kurzoru
    - implicitni
      ...
      - obecne vefektivnejsi a vykonnejsi nez explicitni
...
- ulozene procedury a funkce, baliky, kompilace, spusteni
  - zaznamy
    - = struktura zapozdrujici vice polozek i rozdilnych datovych typu
  ...
  - rozdil mezi procedurou a funkci
    ...
    - funkce
      ...
      - nemuze obsahovat obslusu vyjimet
      - neni mozne v ni provest transakci
      - muze byt pouzita jako soucast dotazu (napr. SELECT)

      <img src="img/20/07.png">

    - => hlavni rozdil je v tom ze zatimco funkce se typicky pouzivaji v ramci SELECT, INSTERST nebo DELETE prikazu, procedury se typicky pouzivaji pro implementaci business logiky
  ...
  - balicky
    ...
    - jak presne se balicek chova zavisi na jeho implementaci
      - typicku jsou ale zkompilovany a ulozeny do DB
