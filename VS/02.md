...
- iterativni vyvoj SW je jistym zpusobem reakci na zmenici se kontext SW vyvoje
  ...
  - vidi proces vyvoje SW jako posloupnost iteraci
    - => jednotek prace ktere cca odpovidaji vodopadovemu modelu a ve kterych se vyskytuji prislusne aktivity
      - aktivity provadene v ramci iteraci se v principu nemeni
      - ale jejich podil na celkovem case se meni v zavislosti na fai vyvoje (viz RUP model)
  - cilem iterace = iteracni release
    - produkt funkce neuplny (neobsahuje veskerou funkcnionalitu) ale funkci a otestovani
  - zaroven iterativni pristup ma vpozitivni psychologicky  vliv
...
- iterativni pristup k vyvoji umoznuje predejit tzv. "late desing breakage"
...
- UP (= Unified Process)
  ...
  - RUP
    ...
    - zakladnimy jednotkami RUP jsou role, artefakty a tasky
...
- Scrum
  ...
  - Scrum definuje nekolik roli
    - Scrum master
      ...
      - ma za cil mit funkci a produktivni tym
      - zajistuje izolaci tymu od externich vlivu
    - Product owner
      - osoba zodpovedna za produkt a jeho ROI (= Return on Investment)
      - reprezentuje zajmky zakaznika, prioritizuje, rozhoduje obsah obsah a vydani
...
- planovani
  - v ramzi vyvoje SW je podstatne planovani
    - prediktivni
    ...
    - adaptivni
      ...
      - jsou tu dva problemy - narocnost a orientace
        - je potreba mit kvalistni management
  ...
  - agilni planovani max cas a zdroje pevne
  ...
  - je potreba resit cas
    - pouzivame metriky jako MH (= man hour) nebo story points
  ...
  - dale je treba zjisti navaznost aktivit
...
- planovani v iterativnim vyvoji
  ...
  - typicky se planuje v prvnim dni iterace
...
- sledovani prubehu iterace
  ...
  - zmeny uvnitr iterace jsou obecne nedoporucovany az na vyjimky
    - mezi iteracemi je idelani cas na to delat upravu planu
...
- jsme schopni planovat iterace ale nevime jak moc dopredu
  ...
  - k tomu slouzi metroky vykonnosti typu
    - team velocity = prumerna hodnota za poslednich `n > 2` iteraci kterou pak muzeme pouzit pro projekce do budoucna
...
- neco z EITM
  ...
  - kriticke faktory uspechu
    ...
    - formalni metodika
    - spolehlive odhady
    - apojeni uzivatelu (stakeholderu)
    - dobra KOMUNIKACE!
  - faktory neuspechu
