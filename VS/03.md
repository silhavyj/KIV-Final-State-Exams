...
- faze zahajeni koncici milnikem LCO (= Life Cycle Objectives) ma za cil definovat ucel SW produktu
  - = vize produktu (ucel a duvod projektu z hlediska zainteresovanych osob = stakeholderu)
    - popis problemu a ucel (ekonomicka navratnost)
    - seznam stakeholderu
...
- faze konstrukce koncici milnikem LCA (= Life Cycle Architecture) se take na definici ucelu podili protoze v ni proboha shromazdovani pozadavku
  - ted jiz detailnich
...
- meotdy ziskavani a definice pozadavku
  ...
  - pozadavek
    ...
    - pozadavek musi byt jednoznacni, uplny, jedinecny, trasovatelny a overitelny!
    ...
    - typy pozadavku
      ...
      - mimofunkci (skalovatelnost, pouzity typ DB, ...)
    ...
    - postup pro ziskavani pozadavku je typicky nasledujici
      ...
      - pote je potreba je spravovat (new, viewed, accepted, released, ...)
    ...
    - je pak otazka jak pozadavky formalizovat
      ...
      - use-case (pripad uziti)
        ...
        - typicky pak obsahuje popis, aktery, stav pred provedenim akce, trigger, stav po provedeni akce a seznam aktivit
    ...
    - pozadavky jsou kladeny i na data
      - cilem je zachytit domenu uzivatele a tedy i informace ktere system pak zpracovava
        ...
        - domenovy model
          - popisuje strukturu problemove oblasi
          - obsahuje zakladni abstrakce a jejich vlastnosti a vztahy
          - nezavisly na implementaci
          - typicky navyva podoby propojenych domenovych objektu
...
- FURPS+
  - = model tridy vlastnosti systemu (tridy kvality)
    ...
    - U -> usability (je system pouzitelny nebo je to jako spraovate emaily v terminalu)
    - R -> reliability (je system stabilni nebo to obcas spadne kvuli memory leaku?)
    - P -> performace (je system vykonny nebo cekam 20 let nez se nacte?)
