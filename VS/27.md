...
- datove typy pro cas
  ...
  - husta reprezentace
    - pomerne jednoducha na implementace protoze racionalni cisla jsou "husta" a daji se vyjadrit podilem dvou celych cisel
...
- temporalni SQL
  ...
  - priklady dotazu
    - kdo bral (bere) lek proventil?
      ...
      - TSQL2 provede automaticky slevani a tak je vysledkem mnozina radku, kazdy asociovany s jednou nevo vice maximalnich period behem kterych pacient bral alespon jeden lek
  ...
  - shrnuti
    ...
    - restrukturalizace
      - provede projekti na vybrane sloupce a provede sliti casu platnosti ekvivalentnich radku
